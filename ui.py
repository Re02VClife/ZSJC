...
from config import CONFIG, CONFIG_DEFAULT, color_manager, get_settings_path
from widgets import DraggablePanel, draw_wave_multi


class UIMixin:
    """全部 UI 构建、布局管理、波形绘制、统计重置等"""
    ...
    def open_settings(self):
        ...
        win.after(100, self._draw_settings_wave)
        win.protocol("WM_DELETE_WINDOW", on_close)
    ...
    def draw_wave(self):
        ...
        draw_wave_multi(self.canvas, data_list,
                        CONFIG["WAVE_HISTORY_SEC"], CONFIG["WAVE_MAX_Y"],
                        self.elapsed_time, self.wave_margin_left, self.wave_margin_top,
                        self.wave_margin_right, self.wave_margin_bottom, "60s")
    ...
    def draw_wave2(self):
        ...
        draw_wave_multi(self.canvas2, data_list,
                        CONFIG["WAVE2_HISTORY_SEC"], CONFIG["WAVE_MAX_Y"],
                        self.elapsed_time, self.wave_margin_left, self.wave_margin_top,
                        self.wave_margin_right, self.wave_margin_bottom, "25min")
